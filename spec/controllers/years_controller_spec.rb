...
RSpec.describe YearsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested year as @year" do
      year = Year.create! valid_attributes
      get :show, params: {id: year.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested year as @year" do
      year = Year.create! valid_attributes
      get :edit, params: {id: year.to_param}, session: valid_session
      expect(assigns(:year)).to eq(year)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Year" do
        expect {
          post :create, params: {year: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved year as @year" do
        post :create, params: {year: invalid_attributes}, session: valid_session
        expect(assigns(:year)).to be_a_new(Year)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested year" do
        year = Year.create! valid_attributes
        put :update, params: {id: year.to_param, year: new_attributes}, session: valid_session
        year.reload
      ...
      it "assigns the requested year as @year" do
        year = Year.create! valid_attributes
        put :update, params: {id: year.to_param, year: valid_attributes}, session: valid_session
        expect(assigns(:year)).to eq(year)
      end
    ...
    context "with invalid params" do
      it "assigns the year as @year" do
        year = Year.create! valid_attributes
        put :update, params: {id: year.to_param, year: invalid_attributes}, session: valid_session
        expect(assigns(:year)).to eq(year)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested year" do
      year = Year.create! valid_attributes
      expect {
        delete :destroy, params: {id: year.to_param}, session: valid_session
      }.to change(Year, :count).by(-1)
    end
